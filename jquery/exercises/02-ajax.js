  ...
  const addBookToDOM = (item) => {
    ...
    $("#books").append(
      $("<div>")
        ...
        .append($("<h3>").text(item.name).addClass("name"))
        .append($("<p>").text(item.authors[0]).addClass("author"))
        .append($("<p>").text(item.released.substr(0, 4)).addClass("released"))
        .append($("<p>").text(`${item.numberOfPages} pages`).addClass("pages"))
    );
